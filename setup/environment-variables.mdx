...
<ParamField path="VITE_STRIPE_PUBLIC_KEY" type="string" required>
  Your Stripe publishable key for client-side payments.
  ...
  **Example**: `pk_test_51Ab3CdEfGhIjKlMnOpQrStUvWxYz...`
  
  <Warning>
    Use test keys for development (`pk_test_`) and live keys for production (`pk_live_`).
  </Warning>
</ParamField>
...
# Stripe
VITE_STRIPE_PUBLIC_KEY=pk_test_51Ab3CdEfGhIjKlMnOpQrStUvWxYz1234567890
