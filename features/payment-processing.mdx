...
description: "Stripe integration with webhooks for secure payment handling"
---

## Overview

Sabbels Handmade uses Stripe for secure payment processing with a complete checkout flow including payment intents, webhooks, and automatic order status management. The system supports multiple currencies and handles the full payment lifecycle from checkout to confirmation.
